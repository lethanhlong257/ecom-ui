          ...
          <GridContainer className={classes.textCenter} justify="center">
            ...
            <GridItem xs={12} sm={8} md={6}>
              <Button
                color="primary"
                size="lg"
                href="https://www.ecom-ui.com/product/material-kit-react"
                target="_blank"
              >
                Free React Download
              </Button>
              <Button
                color="primary"
                size="lg"
                href="https://www.ecom-ui.com/product/material-kit"
                target="_blank"
              >
                Free HTML Downoad
              </Button>
          ...
          <GridContainer className={classes.textCenter} justify="center">
            <GridItem xs={12} sm={12} md={8}>
              ...
              <h4>
                We've launched{" "}
                <a
                  href="https://www.ecom-ui.com/product/material-kit-pro-react"
                  target="_blank"
                >
            ...
            <GridItem xs={12} sm={8} md={6}>
              ...
              <Button
                color="rose"
                size="lg"
                href="https://www.ecom-ui.com/product/material-dashboard-pro-react"
                target="_blank"
              >
